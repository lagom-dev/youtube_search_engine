    ...
    render() {
        ...
        return (
            <li id={this.props.item.id.videoId} className='result-list-item row'>
                <div className='four columns'> <img alt="Video Thumbnail" src={this.props.item.snippet.thumbnails.default.url} onerror={this.onImageError} className='result-list-item-thumb twelve columns' />
